...
let reducedSum = numberArray.reduce((total, currentValue) => {
  if(currentValue % 2 === 0) {
...
for(i = 0; i < numberArray.length; i++) {
  if(i + numberArray[i] === 512) {
    index = i;
    foundValue = numberArray[i] 
    console.log(`index: ${index}, value: ${numberArray[i]}`);
    break;
  }
}
